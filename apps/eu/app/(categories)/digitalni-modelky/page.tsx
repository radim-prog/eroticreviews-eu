...
export default function DigitalniModelkyPage() {
  ...
  // Získat unikátní lokality z dat
      ...
      <div className="bg-gradient-to-r from-pink-500 to-purple-600 text-white">
        <div className="container mx-auto px-4 py-16">
          ...
          <p className="text-xl opacity-90 max-w-2xl">
            České a slovenské digitální modelky na OnlyFans, Fansly a dalších platformách.
            Ověřené profily s recenzemi od skutečných fanoušků.
          </p>
          ...
          <div className="grid grid-cols-3 gap-4 mt-8 max-w-2xl">
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4">
              ...
              <div className="text-sm opacity-80">Aktivních profilů</div>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4">
          ...
          {filteredPeople.map((person) => (
            ...
            >
              ...
              <div className="relative aspect-[3/4] bg-gradient-to-br from-pink-200 to-purple-300 overflow-hidden">
                ...
                {/* Digital badge */}
                <div className="absolute top-2 left-2 bg-pink-500 text-white rounded-full px-2 py-1 shadow-md flex items-center gap-1">
              ...
              <div className="p-3 flex-1 flex flex-col">
                <h3 className="text-base font-bold text-gray-900 group-hover:text-pink-600 transition line-clamp-1 mb-1">
