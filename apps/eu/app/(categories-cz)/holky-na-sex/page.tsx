      ...
      <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white">
        <div className="container mx-auto px-4 py-16">
          ...
          <p className="text-xl opacity-90 max-w-2xl">
            Profesionální escort služby a společnice v České republice.
            Najděte perfektní společnici na základě ověřených recenzí.
          </p>
          ...
          {filteredPeople.map((person) => (
            ...
            >
              ...
              <div className="p-3 flex-1 flex flex-col">
                <h3 className="text-base font-bold text-gray-900 group-hover:text-blue-600 transition line-clamp-1 mb-1">
