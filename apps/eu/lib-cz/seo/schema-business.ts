...
/**
 * Generuje Schema.org markup pro LocalBusiness
 * Podporuje: podniky/priváty, masážní salony, BDSM studia
 */
export function generateBusinessSchema(org: Organization, reviews: Review[] = []) {
  ...
  return {
    ...
    "@type": "LocalBusiness",
    "name": org.name,
    "description": org.description.substring(0, 200) + "...", // Zkrácený popis
    "address": {
      "@type": "PostalAddress",
